...
(function () {
  ...
  if (tg) {
    try {
      ...
      // Match the host Telegram colour scheme on first paint while keeping the
      // liquid-glass skin as the visual system.
      document.body.classList.add("tg");
      document.body.classList.toggle("dark", tg.colorScheme !== "light");
